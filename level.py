...
android_message = 'Tile left/right to accelerate/brake.\nTouch bottom to shoot.\nTouch top to jump.\n\n'
...
class Level:
    ...
    def __init__(self, endless = False):
      ...
      if not endless:
        ...
        self.phase_messages = [android_message + 
        ...
        self.phases = [[[10, 80], # Shark frequency in first phase.
          ...
          self.phase_messages = [android_message + "This is the endless mode.\nGood luck!"]
